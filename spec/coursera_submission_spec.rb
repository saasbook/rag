...
describe CourseraSubmission do
  describe '#to_json' do
    it 'should return a valid JSON object with Base64-encoded attributes' do
      ...
      json = CourseraSubmission.new(id, email, submission).to_json
  ...
  describe '#load_from_base64' do
    it 'should return a valid CourseraSubmission object' do
      ...
      submission = CourseraSubmission.load_from_base64(base64_text)
